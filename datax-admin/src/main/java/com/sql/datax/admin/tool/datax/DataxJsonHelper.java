...
import com.sql.datax.admin.dto.*;
import com.sql.datax.admin.entity.JobDatasource;
import com.sql.datax.admin.tool.datax.reader.*;
import com.sql.datax.admin.tool.datax.writer.*;
...
import static com.sql.datax.admin.util.JdbcConstants.*;
