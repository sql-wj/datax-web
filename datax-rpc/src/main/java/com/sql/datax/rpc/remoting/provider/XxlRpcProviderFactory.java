package com.sql.datax.rpc.remoting.provider;

import com.sql.datax.rpc.registry.ServiceRegistry;
import com.sql.datax.rpc.remoting.net.Server;
import com.sql.datax.rpc.remoting.net.impl.netty.server.NettyServer;
import com.sql.datax.rpc.remoting.net.params.BaseCallback;
...
import com.sql.datax.rpc.util.NetUtil;
import com.sql.datax.rpc.util.ThrowableUtil;
...
public class XxlRpcProviderFactory {
    ...
    public XxlRpcResponse invokeService(XxlRpcRequest xxlRpcRequest) {
        ...
        if (accessToken != null && !accessToken.trim().isEmpty() && !accessToken.trim().equals(xxlRpcRequest.getAccessToken())) {
